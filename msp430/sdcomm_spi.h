#ifndef _SDCOMM_SPI_H_
#define _SDCOMM_SPI_H_
...
#define SD_INIT_TRY         1
/* Number of times to wait for the card to go idle during the initialization */
#define SD_IDLE_WAIT_MAX    1000
/*
 * Hardcoded timeout for commands. 8 words, or 64 clocks.
 * Do 10 words instead
 */
...
#define CMD0        0
#define CMD0_R      R1
/* Begin initialization process (MMC only) */
#define CMD1        1
#define CMD1_R      R1
/* Check voltage range (only SDv2) */
#define CMD8        8
#define CMD8_R      R7
/* Card sends the CSD */
#define CMD9        9
...
#define CMD10       10
#define CMD10_R     R1
/* Stop a multiple block (steam) read/write operation */
#define CMD12       12
#define CMD12_R     R1B
...
#define ACMD13      13
#define ACMD13_R    R2
/* Get the number of written write blocks */
#define ACMD22      22
#define ACMD22_R    R1
/* Set the number of write blocks to be pre-erased before writing */
#define ACMD23      23
#define ACMD23_R    R1
/* Begin initialization process (SD only) */
#define ACMD41      41
#define ACMD41_R    R1
